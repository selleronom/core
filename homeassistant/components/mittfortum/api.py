...
class LoginError(Exception):
    ...
    def __init__(self, message="Failed to log in to MittFortum") -> None:
        """Initialize the LoginError exception.

        Args:
            message (str, optional): The error message. Defaults to "Failed to log in to MittFortum".
        """
...
class ConfigurationError(Exception):
    ...
    def __init__(self, message="Invalid configuration for MittFortum") -> None:
        ...
        Args:
            message (str, optional): The error message. Defaults to "Invalid configuration for MittFortum".
        """
        self.message = message
        super().__init__(self.message)
